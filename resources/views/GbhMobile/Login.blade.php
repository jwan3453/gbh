...
<body>
	<div class="ui container login-box" >
		...
		<div class="logo-div">
			<img src="../GbhMobile/img/logo.png" class="logo"></div>
		...
		<div class="login-form-box">
			<div class="login-username-box">
				...
				<input type="number" placeholder="请输入手机号" class="login-username-input" />

				<img src="../GbhMobile/img/baise.png" class="login-input-base-right"></div>
